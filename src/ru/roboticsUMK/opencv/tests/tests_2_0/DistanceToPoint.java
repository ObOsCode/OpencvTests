...
//			System.out.println("Distance to object- " + distance + " meters.");
			...
			Imgproc.putText(calibratedFrame1, "Dist:" + Double.toString(Utils.round(distance * super._COMPUTE_DISTANCE_KOEF, 6)), new Point(_clickPoint.x, _clickPoint.y - 40), Core.FONT_ITALIC, 1.5, new Scalar(50, 50, 200), 3);
