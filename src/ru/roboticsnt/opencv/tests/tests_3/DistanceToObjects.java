...
import ru.roboticsnt.opencv.ObjectDetector;
...
//	private final double _COMPUTE_DISTANCE_KOEF = 15.384615385;
	...
	private void drawObjectPositionAndDistance(double distance, Rect rect, Mat frame, Scalar color)
	{
		...
		Imgproc.putText(frame, Double.toString(MathUtils.round(distance, 2)) + "(m)", textPoint, Core.FONT_ITALIC, textScale, color, lineThikness);
	}
