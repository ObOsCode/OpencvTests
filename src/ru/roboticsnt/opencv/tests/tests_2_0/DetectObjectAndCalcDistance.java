...
import ru.roboticsnt.opencv.gui.swing.StereoMatcherPanel;
...
//		String cascadePath = "/home/user/Изображения/detectObjectImages/Roulette/cascade_roulette(p2000n4500).xml";
	...
	private void drawDistance(double distance, Point objectPoint, Mat frame)
	{
		...
		Imgproc.putText(frame, "Dist:" + Double.toString(MathUtils.round(distance, 2)) + "(m)", textPoint, Core.FONT_ITALIC, 2, new Scalar(50, 50, 200), 3);
	}
